...
#   ./node_modules/.bin/grunt package-linux        # -> dist/bitbloq_1.4.3_amd64.deb
#                                                 #    dist/BitbloqOffline-1.4.3.AppImage
#   cd dist && zip -r -q bitbloq-offline-linux-1.4.3.zip BitbloqOfflineLinux/ && cd ..
...
#   ./node_modules/.bin/grunt pkg-nsis-win         # -> dist/bitbloq-offline-setup-1.4.3.exe
#   cd dist && 7z a -r bitbloq-offline-windows-1.4.3.zip BitbloqOfflineWin/ && cd ..
...
#   cd dist && zip -r -q bitbloq-offline-mac-1.4.3.zip BitbloqOfflineMac/ && cd ..
#
# ---------------------------------------------------------------------------
# 4. Upload  (once all assets are collected)
# ---------------------------------------------------------------------------
#   gh release upload v1.4.3 \
#     dist/bitbloq-offline-linux-1.4.3.zip \
#     dist/bitbloq_1.4.3_amd64.deb \
#     dist/BitbloqOffline-1.4.3.AppImage \
#     dist/bitbloq-offline-windows-1.4.3.zip \
