#!/usr/bin/env bash
# Build & package Bitbloq Offline release assets (bitbloq-offline 1.4.0)
#
...
#   ./node_modules/.bin/grunt package-linux        # -> dist/bitbloq_1.4.0_amd64.deb
#                                                 #    dist/BitbloqOffline-1.4.0.AppImage
#   cd dist && zip -r -q bitbloq-offline-linux-1.4.0.zip BitbloqOfflineLinux/ && cd ..
...
#   ./node_modules/.bin/grunt pkg-nsis-win         # -> dist/bitbloq-offline-setup-1.4.0.exe
#   cd dist && 7z a -r bitbloq-offline-windows-1.4.0.zip BitbloqOfflineWin/ && cd ..
...
#   cd dist && zip -r -q bitbloq-offline-mac-1.4.0.zip BitbloqOfflineMac/ && cd ..
#
# ---------------------------------------------------------------------------
# 4. Upload  (once all assets are collected)
# ---------------------------------------------------------------------------
#   gh release upload v1.4.0 \
#     dist/bitbloq-offline-linux-1.4.0.zip \
#     dist/bitbloq_1.4.0_amd64.deb \
#     dist/BitbloqOffline-1.4.0.AppImage \
#     dist/bitbloq-offline-windows-1.4.0.zip \
#     dist/bitbloq-offline-setup-1.4.0.exe \
#     dist/bitbloq-offline-mac-1.4.0.zip
#
